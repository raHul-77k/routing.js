...
class UserRegisterForm(forms.Form):
    ...
    def save(self):
        ...
        if "roll_number" in cleaned_data:
...
class TeacherRegistrationForm(UserRegisterForm):
    """A class to create a form for Teacher's Registration.
    It inherits from UserRegisterForm and removes the roll_number field."""

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Remove the roll_number field from the form
        del self.fields['roll_number']
